...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { attendance: @attendance.attendance, client_id: @attendance.client_id, lesson_id: @attendance.lesson_id }
    end
  ...
  test "should update attendance" do
    patch :update, id: @attendance, attendance: { attendance: @attendance.attendance, client_id: @attendance.client_id, lesson_id: @attendance.lesson_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
